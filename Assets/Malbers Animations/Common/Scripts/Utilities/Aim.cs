...
namespace MalbersAnimations.Utilities
{
    public class Aim : MonoBehaviour, IAim, IAnimatorListener
    {
        ...
        [Space, SerializeField, Tooltip("Layers inlcuded on the Aiming Logic")] 
        ...
        [Space, SerializeField, Tooltip("Forced a Target on the Aiming Logic. Calculate the Aim to a Target")]
        private Transform m_AimTarget;
        [SerializeField, Tooltip("Camera Reference for calculating the Aim From Camera.")]
    ...
    public Transform AimOrigin { get => m_aimOrigin; set => m_aimOrigin = value; }
        ...
        void Awake()
        {
            m_camera = MalbersTools.FindMainCamera();
