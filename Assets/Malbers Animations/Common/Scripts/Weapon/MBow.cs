...
namespace MalbersAnimations.Weapons
{
    ...
    public class MBow : MWeapon, IBow
    {
        ...
        [SerializeField] private Quaternion[] UpperBnInitRotation;
        /// <summary> Default Rotation of the Lower Bow Bones </summary>
        [SerializeField] private Quaternion[] LowerBnInitRotation;
        ...
        /// <summary>  Set all the main Parameters to start using a bow;  </summary>
