   ...
   // [CanEditMultipleObjects]
    public class ZoneEditor : Editor
    {
        ...
        SerializedProperty
            ...
            AutomaticDisabled, stanceAction, statModifier, stanceID, RemoveAnimalOnActive, m_tag, AnimHeight;
        ...
        private void OnEnable()
        {
            ...
            AnimHeight = serializedObject.FindProperty("AnimHeight");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.BeginVertical(MalbersEditor.StyleGray);
            {
                ...
                EditorGUILayout.PropertyField(AnimHeight, new GUIContent("Anim Height", "Set a Height for the Animation of this Zone (Optional)"));
                EditorGUILayout.EndVertical();
