    ...
    public class MAnimalEditor : Editor 
    {
      ...
      //  private ReorderableList Reo_List_Pivots;
        ...
        SerializedProperty
            ...
            LockUpDownMovement, LockHorizontalMovement, LockForwardMovement, SelectedMode, ShowAnimParametersOptional, ShowAnimParameters;
        ...
        private void FindSerializedProperties()
        {
           ...
           // Center = serializedObject.FindProperty("Center");
            ...
            m_AnimHeight = serializedObject.FindProperty("m_AnimHeight");
        ...
        private void ShowAnimParam()
        {
            ...
            EditorGUILayout.BeginVertical(EditorStyles.helpBox);
            {
                ...
                if (ShowAnimParametersOptional.boolValue)
                {
                    ...
                    EditorGUILayout.PropertyField(m_AnimHeight);
                }
            }
            EditorGUILayout.EndVertical();
        }
