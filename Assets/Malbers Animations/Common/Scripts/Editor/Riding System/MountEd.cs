...
namespace MalbersAnimations.HAP
{
    ...
    public class MountEd : Editor
    {
        ...
        SerializedProperty UseSpeedModifiers, MountOnly, DismountOnly, active, mountIdle, instantMount, straightSpine, ID, StraightSpineOffsetTransform, DisableMountTriggers,
