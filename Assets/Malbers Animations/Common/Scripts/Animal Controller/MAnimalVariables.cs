...
namespace MalbersAnimations.Controller
{
    ...
    public partial class MAnimal
    {
        ...
        public float UpDownSmooth { get => MovementAxisSmoothed.y; internal set => MovementAxisSmoothed.y = value; } 
        ...
        public bool Sprint
        {
            ...
            set
            {
                ...
                {
                    if (ActiveStateID.ID == 0 && NewSprint) return;
                    sprint = NewSprint;
        ...
        /// <summary>Check if can Fall on slope while on the ground "Decline Slope"</summary>
        public bool DeepPivotSlope => MainPivotSlope < -maxAngleSlope;
        ...
        internal virtual void SetModeParameters(Mode value)
        {
            if (value != null)
            {
        ...
        public Vector3 Main_Pivot_Point
        {
            ...
            {
                if (Has_Pivot_Chest) 
                    return Pivot_Chest.World(transform);
                else if (Has_Pivot_Hip)
                    return Pivot_Hip.World(transform);
                return transform.TransformPoint(new Vector3(0, Height, 0));
            }
        }
        ...
        public Vector3 TargetSpeed
        {
            get
            {
                ...
                Debug.DrawRay(base.transform.position, forward * SpeedModPos * ScaleFactor * DeltaTime, Color.cyan);
        ...
        public Vector3 GravityDirection { get => gravityDirection; set=> gravityDirection.Value = value; }
        ...
        public bool Grounded
        {
            ...
            internal set
            {
                if (grounded != value)
                {
                    ...
                    {
                        AlingRayCasting();
                        AlignPosition(hit_Hip.distance, DeltaTime, AlignPosLerp * 2);
                    }
                }
            }
        }
        ...
        public bool UseSprint { get => useSprintGlobal; set => useSprintGlobal.Value = value; }
        ...
        [SerializeField, Tooltip("Height Value, Used to have Animation with different heights")] private string m_AnimHeight = "AnimHeight";
        ...
        private bool hasAnimHeight;
        internal bool hasStateStatus = false;
        #endregion
        ...
        #region IDamage
        /// <summary>Who is causing the Damage </summary>
        ...
        public bool ShowAnimParametersOptional = true;
        public bool ShowAnimParameters = true;
