...
namespace MalbersAnimations.Controller
{
    ...
    public class Mode
    {
        ...
        {
            return Abilities.Find(ab => ab.Index == index) != null;
        }
        ...
        public void AnimationTagEnter(int animatorTagHash)
        {
            ...
            if (PlayingMode) return; // Means the mode is already playing  ***************Weird Animator issue when it enters Twice on the ANimation State
